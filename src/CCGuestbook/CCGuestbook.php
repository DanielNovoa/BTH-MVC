...
class CCGuestbook extends CObject implements IController {
  ...
  private $pageTitle = 'conFusion Guestbook Example';
  private $pageHeader = '<h1>Guestbook Example</h1><p>Showing off how to implement a guestbook in conFusion. Now saving to database.</p>';
...
<input type='submit' name='doCreate' value='Create db table' />
</p>
</form>
";
